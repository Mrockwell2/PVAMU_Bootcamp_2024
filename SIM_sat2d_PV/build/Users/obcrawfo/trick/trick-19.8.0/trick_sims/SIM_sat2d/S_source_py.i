%module mcc3aa680d110b2cef781526b89cd7469
...
%import "build/Users/obcrawfo/trick/trick-19.8.0/trick_sims/SIM_sat2d/models/satellite/include/Satellite_py.i"
...
%}
    ...
    public:
        ...
        VariableServerSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "initialization", NULL, 1, "Trick::launch_all_external_applications", "", 1) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "preload_checkpoint", NULL, 1, "vs.suspendPreCheckpointReload", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "restart", NULL, 1, "vs.restart", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "restart", NULL, 1, "vs.resumePostCheckpointReload", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "top_of_frame", NULL, 1, "vs.copy_and_write_top", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "automatic_last", NULL, 1, "vs.copy_and_write_scheduled", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "freeze_init", NULL, 1, "vs.freeze_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "freeze_automatic", NULL, 1, "vs.copy_and_write_freeze_scheduled", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "freeze", NULL, 1, "vs.copy_and_write_freeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "shutdown", NULL, 1, "vs.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
...
exec_register_scheduler(&drd) ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "end_of_frame", NULL, 1, "drd.signal_thread", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "preload_checkpoint", NULL, 1, "drd.preload_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "restart", NULL, 1, "drd.restart", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "shutdown", NULL, 1, "drd.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
%}
    ...
    SatelliteSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "satellite.default_data", "", 60000) ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "satellite.state_init", "", 60000) ;
            job = this->add_job(0, 2, "derivative", NULL, 1, "satellite.state_deriv", "", 60000) ;
            job = this->add_job(0, 3, "integration", NULL, 1, "satellite.state_integ", "", 60000) ;
    }
